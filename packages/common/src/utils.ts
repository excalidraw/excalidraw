import { average } from "@nous-excalidraw/math";

import type { GlobalCoord } from "@nous-excalidraw/math";

import type { FontFamilyValues, FontString } from "@nous-excalidraw/element/types";
