...
export const erasePixelFromFreeDraw = (
    ...
    const p1 = eraserPath[eraserPath.length - 2];
    ...
    const newElements: ExcalidrawFreeDrawElement[] = fragments.map((fragmentPoints, index) => {
        ...
        const pressures = new Array(localPoints.length).fill(element.pressures[0] || 0.5);
