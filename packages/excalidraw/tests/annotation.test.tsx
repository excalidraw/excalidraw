...
describe("annotation tool interactions", () => {
  const h = window.h;
  const mouse = new Pointer("mouse");

  it("opens links while using the annotation tool", async () => {
  ...
  it("activates embeddables on center click while using the annotation tool", async () => {
  ...
  it("doesn't pan in view mode when annotation tool is active", async () => {
    await render(<Excalidraw />);
