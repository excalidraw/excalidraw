...
import {
  ...
  actionToggleHighlighterTool,
  getHighlighterStateUpdate,
  zoomToFit,
...
class App extends React.Component<AppProps, AppState> {
                    ...
                    >
                      ...
                      >
                        <LayerUI
                          ...
                          onHighlighterToolToggle={this.onHighlighterToolToggle}
  ...
  onHighlighterToolToggle = () => {
    this.actionManager.executeAction(actionToggleHighlighterTool);
  };
  ...
  private handleCanvasPointerDown = (
    ...
    if (this.state.activeTool.type === "lasso") {
      ...
      this.handleFreeDrawElementOnPointerDown(
        event,
        this.state.activeTool.type === "highlighter" ? "freedraw" : this.state.activeTool.type,
        pointerDownState,
      );
