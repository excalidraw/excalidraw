...
class App extends React.Component<AppProps, AppState> {
  ...
  public onExportImage = async (
    ...
    if (type === "jpg") {
      try {
        // Reuse same rendering logic as PNG
        ...
        // Convert to JPEG blob (92% quality = good balance)
        ...
        // Trigger download
        const fileName = `${this.getName()}.jpg`;
        ...
        // Optional: fake fileHandle so embedScene still works
