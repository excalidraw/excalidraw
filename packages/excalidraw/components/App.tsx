...
class App extends React.Component<AppProps, AppState> {
  ...
  private onKeyDown = withBatchedUpdates(
    (event: React.KeyboardEvent | KeyboardEvent) => {
      ...
      // prevent browser save-as dialog when Ctrl+S is pressed
      // inside a writable element (e.g. contenteditable text).
      // Without this, the bail-out below returns before
      // actionManager.handleKeyDown can call event.preventDefault().
      if (event[KEYS.CTRL_OR_CMD] && event.key.toLowerCase() === KEYS.S) {
        event.preventDefault();
      }
