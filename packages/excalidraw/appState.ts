...
> => {
  return {
    ...
    lastArabicFontFamily: DEFAULT_ARABIC_FONT_FAMILY,
    lastLatinFontFamily: DEFAULT_LATIN_FONT_FAMILY,
...
>(config: { [K in keyof T]: K extends keyof AppState ? T[K] : never }) =>
  ...
  lastArabicFontFamily: { browser: true, export: false, server: false },
  lastLatinFontFamily: { browser: true, export: false, server: false },
