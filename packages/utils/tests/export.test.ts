...
import * as mockedSceneExportUtils from "@excalidraw-modify/excalidraw/scene/export";
import { diagramFactory } from "@excalidraw-modify/excalidraw/tests/fixtures/diagramFixture";
