...
import * as mockedSceneExportUtils from "@nous-excalidraw/excalidraw/scene/export";
import { diagramFactory } from "@nous-excalidraw/excalidraw/tests/fixtures/diagramFixture";
