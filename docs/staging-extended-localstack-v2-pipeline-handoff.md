...
**Start here for v2.** For the unified pipeline import guide (Compact/Full, Classic/Compound, Stacked/Packed + v2 debugging), see [`terraform-pipeline-import-agent-guide.md`](./terraform-pipeline-import-agent-guide.md). For a **deep semantic placement research mission** (Full + Compound + Packed + All resources, graph-layout-rag, audit checklist), see [`pipeline-semantic-placement-agent-handoff.md`](./pipeline-semantic-placement-agent-handoff.md). For generic pipeline import mechanics (phases, profiler, Vitest playbook), see [`terraform-pipeline-import-debug-handoff.md`](./terraform-pipeline-import-debug-handoff.md). For preset DB / catalog, see [`terraform-import-presets-agent-handoff.md`](./terraform-import-presets-agent-handoff.md). For the prior single-account extended preset (v1), see [`staging-extended-localstack-pipeline-handoff.md`](./staging-extended-localstack-pipeline-handoff.md).
