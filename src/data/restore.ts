...
export const restore = (
  ...
  /** restore takes localAppState (`this.state` or initial state
    from localStorage) so that we don't overwrite local state with default
    values (when values not explicitly specified).
