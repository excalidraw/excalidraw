...
- Added prop `UIOptions.canvasActions.saveAsImage` which implies whether the save as image button should be shown. Defauls to `true` hence the **Save as Image** button is rendered [#3662](https://github.com/excalidraw/excalidraw/pull/3662).
