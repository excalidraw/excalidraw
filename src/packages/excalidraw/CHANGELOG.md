...
- Make history local to a given excalidraw instance. This fixes a case where history was getting shared when you have multiple Excalidraw components on same page [#3481](https://github.com/excalidraw/excalidraw/pull/3481).
