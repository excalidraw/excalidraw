...
- Add [`onMenuToggle`](https://github.com/excalidraw/excalidraw/blob/master/src/packages/excalidraw/README.md#onMenuToggle) prop subscribe to library menu being closed/opened (more menus later) ([#5663](https://github.com/excalidraw/excalidraw/pull/5663)).
