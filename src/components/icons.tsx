...
export const FillHachureIcon = React.memo(
  ({ color, background }: { color: string; background: string }) =>
    createIcon(
      <path
        d="M0 0s0 0 0 0m0 0s0 0 0 0m.133 12.04L10.63-.033M.133 12.04L10.63-.034M2.234 21.818L21.26-.07M2.234 21.818L21.26-.07m-8.395 21.852L31.89-.103M12.865 21.783L31.89-.103m-8.395 21.852L41.208 1.37M23.495 21.75L41.208 1.37m-7.083 20.343l7.216-8.302m-7.216 8.302l7.216-8.302"
        stroke={color}
      />,
      {
        width: 40,
...
export const FillSolidIcon = React.memo(
  ({ color, background }: { color: string; background: string }) =>
    createIcon(<path d="M0 0h120v60H0" strokeWidth={0} fill={color} />, {
      width: 40,
      height: 20,
      style: { background },
    }),
