...
ARG VITE_APP_ROOM_SERVER_URL
ARG VITE_APP_AUTH_SERVER_URL
ARG VITE_APP_DISABLE_SENTRY=true
ARG VITE_APP_DISABLE_FIREBASE=true

ENV VITE_APP_WS_SERVER_URL=$VITE_APP_WS_SERVER_URL
ENV VITE_APP_ROOM_SERVER_URL=$VITE_APP_ROOM_SERVER_URL
ENV VITE_APP_AUTH_SERVER_URL=$VITE_APP_AUTH_SERVER_URL
ENV VITE_APP_DISABLE_SENTRY=$VITE_APP_DISABLE_SENTRY
ENV VITE_APP_DISABLE_FIREBASE=$VITE_APP_DISABLE_FIREBASE
