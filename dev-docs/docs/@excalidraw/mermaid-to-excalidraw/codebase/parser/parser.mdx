...
![image](https://github.com/excalidraw/excalidraw/assets/11256141/18b34873-af75-4ac5-8102-4c43e3626515)
...
![image](https://github.com/excalidraw/excalidraw/assets/11256141/98ad1d50-9cae-4b4c-8714-dc30a0475ef2)
...
For each diagram type, we need a parser as the result of every diagram would differ and dependinng on the data we have to write the parser. Since currently we support flowchart, so here is the [`parseMermaidFlowChartDiagram`](https://github.com/excalidraw/mermaid-to-excalidraw/blob/master/src/converter/types/flowchart.ts#L438) to parse the flowchart diagram.
