...
* [Adding a new chart type](/docs/@excalidraw/mermaid-to-excalidraw/codebase/new-chart) - If you want to help us make the mermaid to Excalidraw Parser more powerful, you will find all information in this section to do so.
