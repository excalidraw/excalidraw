...
Since when *Aggresive Block Filtering* is turned on, the `measureText` API breaks which in turn breaks the Test Elements in your drawings. Here is more [info](https://github.com/excalidraw/excalidraw/pull/6336) on the same.
