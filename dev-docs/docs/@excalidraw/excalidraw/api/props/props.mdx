...
| [`UIOptions`](/docs/@excalidraw/excalidraw/api/props/ui-options) | `object` | [DEFAULT UI OPTIONS](https://github.com/excalidraw/excalidraw/blob/master/packages/common/src/constants.ts#L320) | To customise UI options. Currently we support customising [`canvas actions`](/docs/@excalidraw/excalidraw/api/props/ui-options#canvasactions) |
...
Beyond attributes that Excalidraw elements already support, you can store `custom` data on each `element` in a `customData` object. The type of the attribute is [`Record<string, any>`](https://github.com/excalidraw/excalidraw/blob/master/packages/element/src/types.ts#L81) and is optional.
...
1. `excalidrawElements`: Array of [excalidrawElements](https://github.com/excalidraw/excalidraw/blob/master/packages/element/src/types.ts#L206) in the scene.
...
```js
({ x, y, tool}, button, pointersMap}) => void;
```

1.`{x, y, tool}`: Pointer coordinates, tool will be one of `["pointer", "laser"]`

2.`button`: The position of the button. This will be one of `["down", "up"]`

3.`pointersMap`: Gesture [`pointers`](https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/types.ts#L605) map of the scene
...
<pre>
  (activeTool:{" "}
  <a href="https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/types.ts#L999">
    {" "}
    AppState["activeTool"]
  </a>
  , pointerDownState: <a href="https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/types.ts#L667">
    PointerDownState
  </a>) => void
</pre>
...
<pre>
  (data:{" "}
  <a href="https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/clipboard.ts#L46">
    ClipboardData
  </a>
...
<pre>
  (items:{" "}
  <a href="https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/types.ts#L655">
    LibraryItems
  </a>
  ) => void | Promise&lt;any&gt;
</pre>
...
Determines the `language` of the UI. It should be one of the [available language codes](https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/i18n.ts#L12). Defaults to `en` (English). We also export default language and supported languages which you can import as shown below.
...
| --- | --- |
| `defaultLang` | `string` |
| `languages` | [`Language[]`](https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/i18n.ts#L21) |
