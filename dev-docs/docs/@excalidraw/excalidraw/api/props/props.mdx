...
This is an optional property. Default sites allowed by Excalidraw include YouTube, Vimeo and Figma. You may allow additional sites to be included in iFrames. To allow all sites set the prop to `[/.*/]`.
