...
<pre>
  (element: NonDeleted&lt;ExcalidrawIFrameElement&gt;, appState: <a href="https://github.com/excalidraw/excalidraw/blob/master/src/types.ts#L95">AppState</a>) => JSX.Element | null
</pre>

Allows you to replace the iframes renderer (perhaps not use iframe elements at all).

| Parameter | Type | Description |
| --- | --- | --- |
| `element` | `NonDeleted<ExcalidrawIFrameElement>` | The iframe element to be rendered. |
