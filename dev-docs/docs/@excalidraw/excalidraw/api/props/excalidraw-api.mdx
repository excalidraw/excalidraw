...
The built-in Mermaid export that ships in the Excalidraw app is currently exposed through UI actions such as the context menu and command palette entry, not as a public programmatic API for embedders.
