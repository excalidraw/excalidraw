...
<pre>
  () =>{" "}
  <a href="https://github.com/excalidraw/excalidraw/blob/master/packages/element/src/types.ts#L206">
    ExcalidrawElement[]
  </a>
</pre>
...
| --- | --- | --- | --- |
| target | [ExcalidrawElement](https://github.com/excalidraw/excalidraw/blob/master/packages/element/src/types.ts#L206) &#124; [ExcalidrawElement[]](https://github.com/excalidraw/excalidraw/blob/master/packages/element/src/types.ts#L206) | All scene elements | The element(s) to scroll to. |
