...
This API is especially useful when you render a custom [`<Sidebar/>`](/docs/@nous-excalidraw/excalidraw/api/children-components/sidebar), and you want to toggle it from your app based on a user action.
...
Subscribes to change events, similar to [`props.onChange`](/docs/@nous-excalidraw/excalidraw/api/props#onchange).
