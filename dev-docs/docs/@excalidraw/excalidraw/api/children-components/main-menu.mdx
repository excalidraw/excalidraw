...
| --- | --- | :-: | :-: | --- |
| `onSelect` | `(event: Event) => void` | No | - | Triggered when any item is selected (via mouse). Calling `event.preventDefault()` will stop menu from closing. |
...
| Prop | Type | Required | Default | Description |
| --- | --- | :-: | :-: | --- |
| `onSelect` | `(event: Event) => void` | Yes | - | Triggered when selected (via mouse). Calling `event.preventDefault()` will stop menu from closing. |
...
| Prop | Type | Required | Default | Description |
| --- | --- | :-: | :-: | --- |
| `onSelect` | `(event: Event) => void` | No | - | Triggered when selected (via mouse). Calling `event.preventDefault()` will stop menu from closing. |
