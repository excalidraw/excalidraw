...
The editor comes with a default sidebar on the right (in LTR mode) which contains the library. You can also add your own custom sidebar(s) by rendering this component as a child of `<Excalidraw>`.
