...
```js
import { exportToCanvas } from "@nous-excalidraw/excalidraw";
```
...
```js
import { exportToBlob } from "@nous-excalidraw/excalidraw";
```
...
```js
import { exportToClipboard } from "@nous-excalidraw/excalidraw";
```
