...
```js
import { exportToCanvas } from "@excalidraw-modify/excalidraw";
```
...
```js
import { exportToBlob } from "@excalidraw-modify/excalidraw";
```
...
```js
import { exportToClipboard } from "@excalidraw-modify/excalidraw";
```
