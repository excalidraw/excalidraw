...
This is the simplified element api which would help the users to generate Excalidraw elements programmatically. This is the first version of the Excalidraw element Skeleton API and prone to change before we release it to stable version. Here is the [PR](https://github.com/excalidraw/excalidraw/pull/6546) for reference.
