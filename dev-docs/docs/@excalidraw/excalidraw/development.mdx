---
pagination_prev: "@nous-excalidraw/excalidraw/installation"
---

# Development

This page relates to developing the `@nous-excalidraw/excalidraw` package itself.

## Example app

To start the example app using the `@nous-excalidraw/excalidraw` package, follow the below steps:
