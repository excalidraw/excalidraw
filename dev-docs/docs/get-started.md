...
<div align="center" style={{ display:'flex',flexDirection:'column' }}>
  <a href="https://excalidraw.com">
    <img width="540" src={require('@site/static/img/og-image-sm.png').default} alt="Excalidraw logo: Sketch handrawn like diagrams."/>
  </a>
...
[![Vercel](/assets/vercel.svg)](https://vercel.com) [![Sentry](/assets/sentry.svg)](https://sentry.io) [![Crowdin](/assets/crowdin.svg)](https://crowdin.com)
