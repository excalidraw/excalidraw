...
To control the visibility of the sidebar you can use [`toggleMenu("customSidebar")`](/docs/package/api/props/ref#togglemenu) api available via `ref`.
