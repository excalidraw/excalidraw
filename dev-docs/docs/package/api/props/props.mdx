...
| [`renderTopRightUI`](/docs/package/api/props/render-props#rendertoprightui) | `function` | _ | Function that renders custom UI in top right corner |
| [`renderCustomStats`](/docs/package/api/props/render-props#rendercustomstats) | `function` | _ | Function that can be used to render custom stats on the stats dialog. |
