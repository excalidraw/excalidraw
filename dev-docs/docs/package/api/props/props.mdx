...
| [`UIOptions`](/docs/package/api/props/ui-options) | `object` | [DEFAULT UI OPTIONS](https://github.com/excalidraw/excalidraw/blob/master/src/constants.ts#L143) | To customise UI options. Currently we support customising [`canvas actions`](#canvasactions) |
