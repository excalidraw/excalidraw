...
```jsx live
function ExcalidrawWithCustomMainMenu() {
  return (
...
| --- | --- | --- | --- | --- |
| `onSelect` | `Function` | Yes | _ | The handler is triggered when the item is selected. |
| `children` | `React.ReactNode` | Yes | _ | The content of the menu item |
| `icon` | `JSX.Element` | No | _ | The icon used in the menu item |
| `shortcut` | `string` | No | _ | The shortcut to be shown for the menu item |
...
| Prop | Type | Required | Default | Description |
| --- | --- | --- | --- | --- |
| `href` | `string` | Yes | _ | The `href` attribute to be added to the `anchor` element. |
| `children` | `React.ReactNode` | Yes | _ | The content of the menu item |
| `icon` | `JSX.Element` | No | _ | The icon used in the menu item |
| `shortcut` | `string` | No | _ | The shortcut to be shown for the menu item |
...
| Prop | Type | Required | Default | Description |
| --- | --- | --- | --- | --- |
| `children ` | `React.ReactNode` | Yes | _ | The content of the `Menu Group` |
