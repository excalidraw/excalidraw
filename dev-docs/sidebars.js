  ...
  docs: [
    {
      ...
      items: ["introduction/development"],
    },
...

    {
      ...
      link: {
        type: "doc",
        id: "contributing-guide/introduction-to-the-codebase",
      },
      items: [
        "contributing-guide/folder-structure",
        "contributing-guide/app-state",
        "contributing-guide/actions",
        "contributing-guide/rendering",
        "contributing-guide/elements",
        "contributing-guide/scene",
        "contributing-guide/components",
        "contributing-guide/contexts",
        "contributing-guide/hooks",
        "contributing-guide/utils",
        "contributing-guide/tests",
        "contributing-guide/styling",
        "contributing-guide/env-values",
        "contributing-guide/other",
      ],
    },
  ],
};
