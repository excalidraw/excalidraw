...
import { CasdoorAuth } from "./components/CasdoorAuth";
import { BrowserRouter as Router, Routes, Route } from "react-router-dom";
import { CasdoorCallback } from "./components/CasdoorCallback";
...
const ExcalidrawApp = () => {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/auth/callback" element={<CasdoorCallback />} />
        <Route path="*" element={<TopErrorBoundary>
