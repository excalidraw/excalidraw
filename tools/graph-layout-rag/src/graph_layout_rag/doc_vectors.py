...
from graph_layout_rag.paper_embed import embed_papers, model_spec, paper_text
from graph_layout_rag.paths import DOC_VECTORS_TABLE, related_lance_dir
...
def _sep_token(model: str) -> str:
    ...
    try:
        from graph_layout_rag.paper_embed import _load
