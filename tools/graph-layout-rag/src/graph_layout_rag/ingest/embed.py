...
log = logging.getLogger("graph_layout_rag.embed")
...
class EmbedConfig:
    ...
    def from_env(cls) -> EmbedConfig:
        model = os.getenv("GRAPH_RAG_EMBED_MODEL", DEFAULT_MODEL)
        dims = int(os.getenv("GRAPH_RAG_EMBED_DIMS", str(DEFAULT_DIMS)))
...
def resolve_workers(workers: int | None = None) -> int:
    ...
    env = os.getenv("GRAPH_RAG_WORKERS")
    if env:
