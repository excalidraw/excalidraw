...
from repo_rag.ingest.embed import EmbedStats, prepare_embed_config
...
from repo_rag.paths import CHUNKS_TABLE, profile_index_paths

log = logging.getLogger("repo_rag.ingest.reembed")
...
def run_reembed(
    *,
    ...
    if offset == 0:
        ...
        source_state = load_ingest_state(source_paths)
        state = {
