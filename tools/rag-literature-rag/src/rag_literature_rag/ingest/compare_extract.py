...
from rag_literature_rag.ingest.extract import PDF_BACKENDS, extract_pdf_result
from rag_literature_rag.manifest import load_manifest
from rag_literature_rag.paths import PKG_ROOT
from rag_literature_rag.pdf_text import _HYPHEN_BREAK
...
def _gemini_cost_per_mtok() -> float:
    try:
        return float(os.getenv("RAG_LIT_GEMINI_VISION_COST_PER_MTOK", "2.0"))
    except ValueError:
        return 2.0
