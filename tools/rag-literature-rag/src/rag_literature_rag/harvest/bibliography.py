...
from rag_literature_rag.harvest.checkpoint import RELEVANCE_CHECKPOINT_EVERY, RESOLVE_BATCH_SIZE
from rag_literature_rag.harvest.doi_resolver import _openalex_by_doi, resolve_dois
from rag_literature_rag.harvest.doi_validate import filter_plausible_bibliography_dois, is_plausible_bibliography_doi
...
from rag_literature_rag.harvest.relevance import is_known_offtopic_doi, is_layout_relevant
from rag_literature_rag.harvest.tags_inference import infer_harvest_tags
from rag_literature_rag.manifest import ManifestItem, load_manifest, relative_local_path
from rag_literature_rag.paths import BIBLIOGRAPHY_SCAN_CACHE_DIR, PKG_ROOT, PDF_DIR
...
def read_pdf_text(local_relative: str) -> str:
    from rag_literature_rag.pdf_text import extract_pages_from_path
...
def filter_relevant_dois_resumable(
    ...
    *,
    ...
    checkpoint_every = checkpoint_every or _positive_env_int(
        "RAG_LIT_BIB_RELEVANCE_CHECKPOINT_EVERY",
...
def scan_bibliography_candidates(
    *,
    ...
    scan_workers_cap = _positive_env_int("RAG_LIT_BIB_SCAN_WORKERS", BIB_SCAN_WORKERS_DEFAULT)
