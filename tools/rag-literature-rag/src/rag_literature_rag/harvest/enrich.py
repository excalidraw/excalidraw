...
CLI: ``rag-literature-rag harvest enrich [--dry-run] [--workers N]``.
"""
...
from rag_literature_rag.harvest.crossref import _abstract as _crossref_abstract
...
from rag_literature_rag.harvest.rate_limit import (
    domain_from_url,
    note_rate_limit,
    note_success,
    wait_for_domain,
...
_MAILTO = "rag-literature-rag@excalidraw-tf.local"
_UA = f"excalidraw-tf-rag-literature-rag/0.1 (mailto:{_MAILTO})"
