...
from rag_literature_rag.harvest.archive_fallback import archive_pdf_urls
from rag_literature_rag.harvest.doi_validate import is_well_formed_doi
...
from rag_literature_rag.harvest.ledger import set_harvest_stage, update_document
from rag_literature_rag.harvest.parallel import parallel_map
from rag_literature_rag.harvest.providers import OPENALEX, SEMANTIC_SCHOLAR, OutcomeKind
...
log = logging.getLogger("rag_literature_rag.harvest.doi")

USER_AGENT = "mailto:rag-literature-rag@excalidraw-tf.local"
UNPAYWALL_EMAIL = "rag-literature-rag@excalidraw-tf.local"
