"""Harvest RAG papers from arXiv API."""
...
ARXIV_CATEGORIES = "cat:cs.CL OR cat:cs.IR OR cat:cs.AI OR cat:cs.LG"
...
def _search_arxiv(query: str, *, max_results: int = 50) -> list[dict]:
    ...
    search = f"all:{query} AND ({ARXIV_CATEGORIES})"
    params = {
        "search_query": search,
        "start": "0",
