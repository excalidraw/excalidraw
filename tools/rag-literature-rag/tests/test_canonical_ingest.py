from rag_literature_rag.ingest.canonical import canonical_ingest_projection
from rag_literature_rag.ingest.run import ExtractionOutcome, _mark_outcome_ingested
