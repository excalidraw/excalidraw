...
from rag_literature_rag.query.citation_rank import (
    CitationGraph,
...
from rag_literature_rag.query.identity import CanonicalIdentityMap
...
def test_related_to_docs_resolves_seed_alias_and_deduplicates_results(monkeypatch):
    ...
    monkeypatch.setattr(
        "rag_literature_rag.query.identity.canonical_identity_map",
        lambda: identities,
    )
